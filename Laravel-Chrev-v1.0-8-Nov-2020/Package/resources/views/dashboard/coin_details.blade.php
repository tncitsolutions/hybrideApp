...
@section('content')
				...
				<div class="row">
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6 ">
						<div class="card currency-bx overflow-hidden relative bg-warning">
							<div class="card-body p-4">
								<div class="media align-items-center">
									<div class="media-body">
										...
										<h1 class="text-white mb-0">$65,123</h1>
									</div>
							...
							<img class="bg-img" src="{{ asset('images/money/bitcoin.svg') }}" alt=""/>
						</div>
					</div>
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6 ">
						<div class="card currency-bx overflow-hidden relative bg-secondary">
							<div class="card-body p-4">
								<div class="media align-items-center">
									<div class="media-body">
										<h5 class="text-white fs-20">Dollar</h5>
										<h1 class="text-white mb-0">$2,251</h1>
									</div>
									<div class="currency-icon">
			...
			s21.984,32,48,32c44.128,0,80,28.704,80,64C336,334.912,308.48,360.768,272,366.72z"/></g></g></svg>
							...
							<img class="bg-img" src="{{ asset('images/money/dollar.svg') }}" alt=""/>
						</div>
					</div>
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6 ">
						<div class="card currency-bx overflow-hidden relative bg-info">
							<div class="card-body p-4">
								<div class="media align-items-center">
									<div class="media-body">
										<h5 class="text-white fs-20">Euro</h5>
										<h1 class="text-white mb-0">$12,123</h1>
									</div>
									<div class="currency-icon">
			...
			c-4.96,7.36-14.976,9.152-22.208,4.192C299.072,164.128,285.952,160,272,160c-29.472,0-55.008,19.456-68.864,48H272z"/></g></g></svg>
							...
							<img class="bg-img" src="{{ asset('images/money/euro.svg') }}" alt=""/>
						</div>
					</div>
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6 ">
						<div class="card currency-bx overflow-hidden relative bg-dark">
							<div class="card-body p-4">
								<div class="media align-items-center">
									<div class="media-body">
										<h5 class="text-white fs-20">Turkish</h5>
										<h1 class="text-white mb-0">$6,512</h1>
									</div>
									<div class="currency-icon">
							...
							<img class="bg-img" src="{{ asset('images/money/turkish-lira.svg') }}" alt=""/>
						</div>
					</div>
				</div>
                <div class="row">
					<div class="col-xl-9 col-xxl-12 col-lg-12">
						<div class="card">
							<div class="card-header border-0 pb-0 ">
								<div>
									<h4 class="fs-20 text-black">Coin Chart</h4>
									<p class="mb-0 fs-13">Lorem ipsum dolor sit amet</p>
								</div>
								<div class="dropdown ml-auto custom-dropdown d-none d-md-block  mt-3 mt-sm-0">
									<div class="btn bgl-light d-flex align-items-center rounded-0 svg-btn " data-toggle="dropdown">
										<i class="fa fa-calendar-o scale5 text-dark mr-4"></i>
										<div class="text-left">
											<span class="d-block text-black fs-14">4 June 2020 - 17 June 2020</span>
										</div>
									</div>
								...
								<div class="dropdown ml-3 custom-dropdown d-none d-md-block  mt-3 mt-sm-0">
									<div class="btn bgl-light d-flex align-items-center rounded-0 svg-btn " data-toggle="dropdown">
										<div class="text-left">
											<span class="d-block text-black fs-14">USD ($ US Dollar)</span>
										</div>
							...
							<div class="card-body">
								<div class="row sp20 mb-4 align-items-center">
									...
									<div class="col-lg-6 col-md-8">
										<div class="row sp20">
											<div class="col-lg-4 col-sm-4 col-6 mb-3 mb-sm-0">
									...
									<div class="d-lg-flex d-none col-lg-3 justify-content-end align-items-center">
										<div class="text-right">
											<h2 class="fs-24 font-w600 text-black mb-0">Bitcoin</h2>
											<span class="fs-14 font-w600">BTC</span>
										</div>
										<img class="ml-3 width60 height60" height="60" width="60" src="{{ asset('images/svg/bitcoin.svg') }}" alt="">
									</div>
								</div>
								<div id="chart"></div>
							</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="text-center mb-3">
									<img class="ml-auto mb-3 mr-auto d-block" src="{{ asset('images/svg/bitcoin.svg') }}" alt="">
									<h2 class="fs-24 font-w600 text-black mb-0">Bitcoin</h2>
									<span class="fs-14 font-w600">BTC</span>
								</div>
								<p class="fs-14">Bitcoin was the first cryptocurrency to successfully record transactions on a secure, decentralized blockchain-based network. Launched in early 2009 by its pseudonymous creator Satoshi Nakamoto, Bitcoin is the largest cryptocurrency measured by market capitalization and amount of data stored on its blockchain. </p>
								<p class="fs-14">The Bitcoin software is free and available online to anyone who wants to run a Bitcoin node and store their own copy of the Bitcoin blockchain</p>
							</div>
							<div class="card-footer border-0 pt-0 text-center">
								<a href="javascript:void(0);" class="btn-link d-flex">Read more <i class="fa fa-chevron-right text-dark ml-auto scale-2"></i></a>
							</div>
						</div>
					</div>
